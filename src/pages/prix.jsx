    ...
    return(
        <div class="grid min-h-[90vh]">
            ...
            <Modal isVisible={showBourseModal} onClose={() => setShowBourseModal(false)}>
              ...
              J'ai eu le grand honneur de recevoir la bourse d'admission Innovation Ted Rogers. Il s'agit d'une bourse de 100 000$ remis à 10 étudiants au canada. Les critères de sélection était l'excellence accadémique et un grand intéret pour les technologies (souligné par nombreux de mes professeurs de science).
              </h1>           
            </Modal>
        </div>
    )
